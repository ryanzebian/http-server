...
var colors = require('./lib/colors/colors'),
  ...
  portfinder = require('./lib/portfinder/portfinder'),
  opener = require('./lib/opener/opener'),
...
function listen(port) {
  ...
  server.listen(port, host, function () {
    ...
    if (argv.o) {
      console.log(protocol + canonicalHost + ':' + port);
      console.log({ command: argv.o !== true ? argv.o : null });
      opener(
